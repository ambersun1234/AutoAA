class aaConfig:
    ...
    specialOfferVipHField    = "airasia-"
    specialOfferVipTField    = "-div-show-bundle-details"
    ...
    specialOfferdrField      = "hide-on-small-and-down"
    specialOfferPriceField   = "price-total"
